//
//  MemoriaSuperatoViewController.swift
//  App2
//
//  Created by Franco Cirillo on 06/04/21.
//

import UIKit
import AVFoundation

class MemoriaSuperatoViewController: UIViewController {
...
//        DispatchQueue.main.asyncAfter(deadline: .now() + .seconds(1), execute: {
            ...
            newViewController = storyBoard.instantiateViewController(withIdentifier: "MemoriaViewController") as! MemoriaViewController
