//
//  IndovinaSuperatoViewController.swift
//  App2
//
...
class IndovinaSuperatoViewController: UIViewController {
...
//        DispatchQueue.main.asyncAfter(deadline: .now() + .seconds(1), execute: {
            ...
            if self.livello==(nlivelli!+1) {
                 ...
                 newViewController = storyBoard.instantiateViewController(withIdentifier: "IndovinaViewController") as! IndovinaViewController
                //newViewController.isModalInPresentation = true
                self.navigationController?.pushViewController(newViewController, animated: true)
                
            } else{
                 newViewController = storyBoard.instantiateViewController(withIdentifier: "Indovina") as! Indovina
                let c=newViewController as! Indovina
...
//        }
        ...
        if self.livello==(nlivelli!+1) {
            ...
            //Salva le stelle
            let cc = defaults.integer(forKey: "CategorieCompletateIndovina")
            defaults.set(cc+1, forKey: "CategorieCompletateIndovina")
            defaults.set(Double(stelleTotali)/Double(nlivelli ?? 0 + 1), forKey: "\(categoria ?? "")-percentualeIndovina")
        }
