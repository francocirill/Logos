...
class IndovinaViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "categoriaCell", for: indexPath) as! IndovinaViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
     ...
     case "livelli":
         if let currentIndex=tableView.indexPathForSelectedRow?.row{
            ...
            let dstview=segue.destination as! Indovina
