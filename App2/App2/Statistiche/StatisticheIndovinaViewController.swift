//
//  StatisticheIndovinaViewController.swift
//  App2
//
...
class StatisticheIndovinaViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "statisticheIndovinaCell", for: indexPath) as! StatisticheIndovinaViewCell

        let categoria=listaCategoria[indexPath.row]
        cell.categoria.text=categoria
        let perc = (defaults.double(forKey: "\(categoria)-percentualeIndovina")*100).rounded()/100
